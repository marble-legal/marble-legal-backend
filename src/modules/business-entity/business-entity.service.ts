...
export class BusinessEntityService {
  constructor(@InjectRepository(BusinessEntity)
  ...
  create(createBusinessEntityDto: CreateBusinessEntityDto) {
    return this.businessEnitiesRepository.save({
      ...
      isRestrictionsOnTransfer: createBusinessEntityDto.isRestrictionsOnTransfer,
      restrictionsOnTransferDetail: createBusinessEntityDto.restrictionsOnTransferDetail,
      isProfitsLossSharedEqually: createBusinessEntityDto.isProfitsLossSharedEqually,
